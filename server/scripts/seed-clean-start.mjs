 ...
 * Clean start accounts use simple username + password (not email).
 */
...
try {
  ...
  await client.query(
    ...
    [madamId, 'Principal', 'principal', 'Principal1'],
  )
  await client.query(
    `INSERT INTO nfctag_teachers (id, name, email, password, subject, status, created_by, created_by_name)
     VALUES ($1,$2,$3,$4,$5,'active',$6,$7)`,
    [teacherId, 'Ahmed Raza', 'teacher', 'Teacher1', 'Mathematics', madamId, 'Principal'],
  )
  ...
  await client.query(
    `INSERT INTO nfctag_students (
       ...
       $2,$3,'student','Student1',$4,'Clean start student',$5,'Principal'
     )`,
...
console.log('Clean accounts ready (username / password):')
